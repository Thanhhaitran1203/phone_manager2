...
<div>
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 style="margin-left: 10px" class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Product</h2>
        </div>
    </div>
                        ...
                        <div class="-my-2 overflow-x-auto -mx-4 sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    <a style="margin-left: 10px" href="/phone?action=create" >Create new phone</a>
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Phone Category</th>
                                        ...
                                        <c:forEach items='${requestScope["phoneList"]}' var="phone">
                                            <c:if test="${phone.getDisplay() == 1}">
                                                <tr class="odd:bg-white even:bg-gray-100">
                                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${phone.getName()}</td>
                                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${phone.getPrice()}</td>
                                                    ...
                                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${phone.getDescription()}</td>
                                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><a href="/phone?action=edit&id=${phone.getId()}" class="hover:text-indigo-500">Edit</a></td>
                                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><a href="/phone?action=delete&id=${phone.getId()}" class="hover:text-indigo-500">Delete</a></td>
                                                </tr>
                                            </c:if>
                                        </c:forEach>
                                        </tbody>
